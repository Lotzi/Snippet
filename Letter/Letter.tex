...
\begin{document}
	...
	% Absendername
	\setkomavar{fromname}{Paul Otto}
	
	% Absenderadresse
	\setkomavar{fromaddress}{Musterweg 3 \\ 91238 Holzhausen}
	
	% Absendertelefonnummer
	\setkomavar{fromphone}{+49 15267 4133123}
	...
	\setkomavar{fromemail}{\href{mailto:mail@gmail.com}{mail@gmail.com}}
	...
	% Betreff
	\setkomavar{subject}{Stempelpass Moselsteig}
